...
// of the following is a bit hacky...
	...
	/// <summary>
	/// The base class for all parameters types stored in a <see cref="UnityEngine.Rendering.VolumeComponent"/>.
	/// </summary>
	/// <seealso cref="ScriptableVolumeParameter{T}"/>
	public abstract class ScriptableVolumeParameter : ICloneable
	{
		/// <summary>
		...
		[SerializeField, HorizontalGroup(Width = 15), HideLabel]
		...
		internal abstract void Interp(ScriptableVolumeParameter from, ScriptableVolumeParameter to, float t);
		...
		public T GetValue<T>()
		{
			return ((ScriptableVolumeParameter<T>)this).value;
		}

		/// <summary>
		/// Sets the value of this parameter to the value in <paramref name="parameter"/>.
		/// </summary>
		/// <param name="parameter">The <see cref="ScriptableVolumeParameter"/> to copy the value from.</param>
		public abstract void SetValue(ScriptableVolumeParameter parameter);

		/// <summary>
		/// Unity calls this method when the parent <see cref="UnityEngine.Rendering.VolumeComponent"/> loads.
		/// </summary>
		/// <remarks>
		/// Use this if you need to access fields and properties that you can not access in
		/// the constructor of a <c>ScriptableObject</c>. (<see cref="ScriptableVolumeParameter"/> are
		/// generally declared and initialized in a <see cref="UnityEngine.Rendering.VolumeComponent"/>, which is a
		...
		/// <summary>
		/// Clones the current instance of the <see cref="ScriptableVolumeParameter"/>
		/// </summary>
		/// <returns>A new created instance with the same values as the current instance of <see cref="ScriptableVolumeParameter"/></returns>
		public abstract object Clone();
	}

	/// <summary>
	/// A generic implementation of <see cref="ScriptableVolumeParameter"/>. Custom parameters should derive
	...
	/// directly to declare parameters in a <see cref="UnityEngine.Rendering.VolumeComponent"/>. Instead, use one of the
	...
	/// </code>
	/// </example>
	/// <seealso cref="ScriptableVolumeParameter"/>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class ScriptableVolumeParameter<T> : ScriptableVolumeParameter, IEquatable<ScriptableVolumeParameter<T>>
	{
		/// <summary>
		...
		protected ScriptableVolumeParameter(T value, bool overrideState = false)
		{
			m_Value = value;
			this.overrideState = overrideState;
		}

		internal override void Interp(ScriptableVolumeParameter from, ScriptableVolumeParameter to, float t)
		{
			// Note: this is relatively unsafe (assumes that from and to are both holding type T)
			Interp((from as ScriptableVolumeParameter<T>).value, (to as ScriptableVolumeParameter<T>).value, t);
		}
		...
		{
			m_Value = ((ScriptableVolumeParameter<T>)parameter).m_Value;
		}
		...
		/// </summary>
		/// <param name="lhs">The first value in a <see cref="ScriptableVolumeParameter"/>.</param>
		/// <param name="rhs">The second value.</param>
		/// <returns><c>true</c> if both values are equal, <c>false</c> otherwise.</returns>
		public static bool operator ==(ScriptableVolumeParameter<T> lhs, T rhs) => lhs != null && !ReferenceEquals(lhs.value, null) && lhs.value.Equals(rhs);
		...
		public static bool operator !=(ScriptableVolumeParameter<T> lhs, T rhs) => !(lhs == rhs);
		...
		public bool Equals(ScriptableVolumeParameter<T> other)
		{
		...
		public override bool Equals(object obj)
		{
			...
			return Equals((ScriptableVolumeParameter<T>)obj);
		}

		/// <inheritdoc/>
		public override object Clone()
		{
			return new ScriptableVolumeParameter<T>(GetValue<T>(), overrideState);
		}

		/// <summary>
		/// Explicitly downcast a <see cref="ScriptableVolumeParameter{T}"/> to a value of type
		/// <typeparamref name="T"/>.
		/// </summary>
		/// <param name="prop">The parameter to downcast.</param>
		/// <returns>A value of type <typeparamref name="T"/>.</returns>
		public static explicit operator T(ScriptableVolumeParameter<T> prop) => prop.m_Value;
	}
	...
	/// <typeparam name="T">The type of value to hold in this parameter.</typeparam>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public sealed class EnumParameter<T> : ScriptableVolumeParameter<T>
	{
		/// <summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a <c>bool</c> value.
	/// </summary>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class BoolParameter : ScriptableVolumeParameter<bool>
	{
		/// <summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a <c>LayerMask</c> value.
	/// </summary>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class LayerMaskParameter : ScriptableVolumeParameter<LayerMask>
	{
		/// <summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds an <c>int</c> value.
	/// </summary>
	...
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class IntParameter : ScriptableVolumeParameter<int>
	{
		/// <summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a non-interpolating <c>int</c> value.
	/// </summary>
	...
	/// <seealso cref="NoInterpClampedIntParameter"/>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class NoInterpIntParameter : ScriptableVolumeParameter<int>
	{
		/// <summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds an <c>int</c> value clamped to a
	/// minimum value.
	/// </summary>
	/// <seealso cref="IntParameter"/>
	/// <seealso cref="MaxIntParameter"/>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a non-interpolating <c>int</c> value that
	...
	/// <seealso cref="NoInterpClampedIntParameter"/>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class NoInterpMinIntParameter : ScriptableVolumeParameter<int>
	{
		/// <summary>
		/// The minimum value to clamp this parameter to.
		/// </summary>
	...
	/// <seealso cref="NoInterpClampedIntParameter"/>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class NoInterpMaxIntParameter : ScriptableVolumeParameter<int>
	{
		/// <summary>
		/// The maximum value to clamp this parameter to.
		/// </summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds an <c>int</c> value clamped between a
	...
	/// <seealso cref="NoInterpMaxIntParameter"/>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class NoInterpClampedIntParameter : ScriptableVolumeParameter<int>
	{
		/// <summary>
		/// The minimum value to clamp this parameter to.
		/// </summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a <c>float</c> value.
	/// </summary>
	...
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class FloatParameter : ScriptableVolumeParameter<float>
	{
		/// <summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a non-interpolating <c>float</c> value.
	/// </summary>
	...
	/// <seealso cref="NoInterpFloatRangeParameter"/>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class NoInterpFloatParameter : ScriptableVolumeParameter<float>
	{
		/// <summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a <c>float</c> value clamped to a minimum value.
	/// </summary>
	/// <seealso cref="FloatParameter"/>
	/// <seealso cref="MaxFloatParameter"/>
	/// <seealso cref="ClampedFloatParameter"/>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a non-interpolating <c>float</c> value clamped to
	/// a minimum value.
	/// </summary>
	/// <seealso cref="FloatParameter"/>
	/// <seealso cref="MinFloatParameter"/>
	...
	/// <seealso cref="NoInterpFloatRangeParameter"/>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class NoInterpMinFloatParameter : ScriptableVolumeParameter<float>
	{
		/// <summary>
		/// The minimum value to clamp this parameter to.
		/// </summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a <c>float</c> value clamped to a max value.
	/// </summary>
	/// <seealso cref="FloatParameter"/>
	/// <seealso cref="MinFloatParameter"/>
	/// <seealso cref="ClampedFloatParameter"/>
	...
	/// <seealso cref="NoInterpFloatRangeParameter"/>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class NoInterpMaxFloatParameter : ScriptableVolumeParameter<float>
	{
		/// <summary>
		/// The maximum value to clamp this parameter to.
		/// </summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a <c>float</c> value clamped between a minimum and a
	/// maximum value.
	/// </summary>
	/// <seealso cref="FloatParameter"/>
	/// <seealso cref="MinFloatParameter"/>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a non-interpolating <c>float</c> value clamped between
	...
	/// <seealso cref="NoInterpFloatRangeParameter"/>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class NoInterpClampedFloatParameter : ScriptableVolumeParameter<float>
	{
		/// <summary>
		/// The minimum value to clamp this parameter to.
		/// </summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a <c>Vector2</c> value holding a range of two
	...
	/// <seealso cref="NoInterpFloatRangeParameter"/>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class FloatRangeParameter : ScriptableVolumeParameter<Vector2>
	{
		/// <summary>
		/// The minimum value to clamp this parameter to.
		/// </summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a non-interpolating <c>Vector2</c> value holding
	...
	/// <seealso cref="NoInterpClampedFloatParameter"/>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class NoInterpFloatRangeParameter : ScriptableVolumeParameter<Vector2>
	{
		/// <summary>
		/// The minimum value to clamp this parameter to.
		/// </summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a <c>Color</c> value.
	/// </summary>
	/// <seealso cref="NoInterpColorParameter"/>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class ColorParameter : ScriptableVolumeParameter<Color>
	{
		/// <summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a non-interpolating <c>Color</c> value.
	/// </summary>
	/// <seealso cref="ColorParameter"/>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class NoInterpColorParameter : ScriptableVolumeParameter<Color>
	{
		/// <summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a <c>Vector2</c> value.
	/// </summary>
	/// <seealso cref="NoInterpVector2Parameter"/>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class Vector2Parameter : ScriptableVolumeParameter<Vector2>
	{
		/// <summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a non-interpolating <c>Vector2</c> value.
	/// </summary>
	/// <seealso cref="Vector2Parameter"/>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class NoInterpVector2Parameter : ScriptableVolumeParameter<Vector2>
	{
		/// <summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a <c>Vector3</c> value.
	/// </summary>
	/// <seealso cref="NoInterpVector3Parameter"/>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class Vector3Parameter : ScriptableVolumeParameter<Vector3>
	{
		/// <summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a non-interpolating <c>Vector3</c> value.
	/// </summary>
	/// <seealso cref="Vector3Parameter"/>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class NoInterpVector3Parameter : ScriptableVolumeParameter<Vector3>
	{
		/// <summary>
		/// Creates a new <see cref="Vector3Parameter"/> instance.
		/// </summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a <c>Vector4</c> value.
	/// </summary>
	/// <seealso cref="NoInterpVector4Parameter"/>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class Vector4Parameter : ScriptableVolumeParameter<Vector4>
	{
		/// <summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a non-interpolating <c>Vector4</c> value.
	/// </summary>
	/// <seealso cref="Vector4Parameter"/>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class NoInterpVector4Parameter : ScriptableVolumeParameter<Vector4>
	{
		/// <summary>
		/// Creates a new <see cref="Vector4Parameter"/> instance.
		/// </summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a <c>Texture</c> value.
	/// </summary>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class TextureParameter : ScriptableVolumeParameter<Texture>
	{
		/// <summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a non-interpolating <c>Texture</c> value.
	/// </summary>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class NoInterpTextureParameter : ScriptableVolumeParameter<Texture>
	{
		/// <summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a 2D <c>Texture</c> value.
	/// </summary>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class Texture2DParameter : ScriptableVolumeParameter<Texture>
	{
		/// <summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a 3D <c>Texture</c> value.
	/// </summary>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class Texture3DParameter : ScriptableVolumeParameter<Texture>
	{
		/// <summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a <c>RenderTexture</c> value.
	/// </summary>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class RenderTextureParameter : ScriptableVolumeParameter<RenderTexture>
	{
		/// <summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a non-interpolating <c>RenderTexture</c> value.
	/// </summary>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class NoInterpRenderTextureParameter : ScriptableVolumeParameter<RenderTexture>
	{
		/// <summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a <c>Cubemap</c> value.
	/// </summary>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class CubemapParameter : ScriptableVolumeParameter<Texture>
	{
		/// <summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a non-interpolating <c>Cubemap</c> value.
	/// </summary>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class NoInterpCubemapParameter : ScriptableVolumeParameter<Cubemap>
	{
		/// <summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a serializable class or struct.
	/// </summary>
...
// TODO: ObjectParameter<T> doesn't seem to be working as expect, debug me
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class ObjectParameter<T> : ScriptableVolumeParameter<T>
	{
		internal ReadOnlyCollection<ScriptableVolumeParameter> parameters { get; private set; }
		...
		public sealed override T value
		{
			...
			set
			{
				...
				parameters = m_Value.GetType()
					...
					.Where(t => t.FieldType.IsSubclassOf(typeof(ScriptableVolumeParameter)))
					.OrderBy(t => t.MetadataToken)// Guaranteed order
					.Select(t => (ScriptableVolumeParameter)t.GetValue(m_Value))
					.ToList()
					.AsReadOnly();
			}
		}
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds an <c>AnimationCurve</c> value.
	/// </summary>
	[Serializable]
	public class AnimationCurveParameter : ScriptableVolumeParameter<AnimationCurve>
	{
		/// <summary>
	...
	/// <summary>
	/// A <see cref="ScriptableVolumeParameter"/> that holds a  <see cref="Material"/> value.
	/// </summary>
	[Serializable, DebuggerDisplay(k_DebuggerDisplay)]
	public class MaterialParameter : ScriptableVolumeParameter<Material>
	{
		/// <summary>
